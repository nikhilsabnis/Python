...
if __name__ == '__main__':
    ...
    minscore = min([score for name, score in students])
    minscore = min([score for name, score in students if score > minscore])
    pupils = sorted([name for name, score in students if score == minscore])
    print('\n'.join(pupils))